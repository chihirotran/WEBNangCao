...
<body>
    ...
    <div class="bs-example">
        ...
        <form id="frmThemMoi" action="" method="POST">
            ...
            <button id="btnThemMoi" type="submit" name="ThemMoi" class="btn btn-primary">Thêm mới</button>
            <button id="btnDangXuat" type="submit" name="DangXuat" class="btn btn-primary">Đăng Xuất</button>
        </form>
        <!-- Using Ajax -->
